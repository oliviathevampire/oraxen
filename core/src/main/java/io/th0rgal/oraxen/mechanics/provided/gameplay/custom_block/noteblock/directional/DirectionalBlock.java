...
public class DirectionalBlock {
    ...
    public NoteBlockMechanic getParentMechanic() {
        ...
        else return (NoteBlockMechanic) NoteBlockMechanicFactory.get().getMechanic(parentBlock);
    }
    ...
    private int getDirectionVariation(String id) {
        return ((NoteBlockMechanic) NoteBlockMechanicFactory.get().getMechanic(id)).getCustomVariation();
    }
