...
public class BukkitPackSender extends PackSender implements Listener {
    ...
    public void sendPack(Player player) {
        if (VersionUtil.isPaperServer()) player.setResourcePack(hostingProvider.getPackURL(), hostingProvider.getSHA1(), AdventureUtils.MINI_MESSAGE.deserialize(prompt), mandatory);
