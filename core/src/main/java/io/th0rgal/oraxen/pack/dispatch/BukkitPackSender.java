...
public class BukkitPackSender extends PackSender implements Listener {
    ...
    public void sendPack(Player player) {
        if (VersionUtil.atOrAbove("1.20.3")) player.setResourcePack(UUID.randomUUID(), hostingProvider.getMinecraftPackURL(), hostingProvider.getSHA1(), AdventureUtils.MINI_MESSAGE.deserialize(prompt), mandatory);
        else player.setResourcePack(hostingProvider.getMinecraftPackURL(), hostingProvider.getSHA1(), AdventureUtils.MINI_MESSAGE.deserialize(prompt), mandatory);
    }
