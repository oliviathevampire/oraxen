...
public enum Settings {
    ...
    ORAXEN_INV_SIZE("oraxen_inventory.menu_info.size"),
    ORAXEN_INV_TITLE("oraxen_inventory.menu_info.title"),
    ORAXEN_INV_NEXT_ICON("oraxen_inventory.menu_info.next_page_button"),
    ORAXEN_INV_PREVIOUS_ICON("oraxen_inventory.menu_info.previous_page_button"),
    ORAXEN_INV_EXIT("oraxen_inventory.menu_info.exit_button");
